...
describe('project.js', () => {
  ...
  describe('setProjectName()', () => {
    ...
    it('should replace text in README.md & package.json', () => {
      ...
      const NAME = 'my-cool-scrypt-project';

      const README = '# sCrypt Project: PROJECT_NAME\n more stuff\n and more';
      ...
      expect(readmeAfter.includes('My Cool sCrypt Project')).toBeTruthy();
      expect(readmeAfter.includes('PROJECT_NAME')).toBeFalsy();
      const packageAfter = fs.readFileSync(
        path.join(DIR, 'package.json'),
        'utf8'
      );
      expect(packageAfter.includes('my-cool-scrypt-project')).toBeTruthy();
  ...
  describe('replaceInFile()', () => {
    it('should replace target content in a file', () => {
      ...
      const str = '# sCrypt Project: PROJECT_NAME\n more stuff';
